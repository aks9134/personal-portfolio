...
const components: MDXComponents = {
  h2: (props) => <h2 id={slug(props.children)} className="clear-both mt-16 scroll-mt-20 border-t-[1.5px] border-ink pt-4 text-3xl font-extrabold tracking-[-0.02em] [font-stretch:108%]" {...props} />,
